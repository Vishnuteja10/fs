...
import Style from "./MembershipTerms.module.css";
        ...
        <div className={Style.card}>
          ...
          <div className={Style.formGroup}>
            ...
            <p>
              ...
              with hospitality usage benefits, annual reward benefits,
              promotional privileges, and access to selected Fracspace-managed
              or affiliated hospitality properties and experiences.
            </p>
          ...
          <div className={Style.formGroup}>
            ...
            <div className={Style.planCard}>
              ...
              <p>
                ...
                <strong>INR 1,00,000/- (Rupees One Lakh Only)</strong>, the
                Member shall be entitled to:
              </p>
              <ul>
                <li>
                  Membership validity for a period of Ten (10) Years from the
                  date of activation.
                </li>
                <li>
                  Up to Four (4) Hospitality Reward Nights during each
                  Membership Year.
                </li>
                <li>
                ...
                <li>
                  ...
                  affiliated hospitality partner properties across India,
                  subject to availability and applicable booking policies.
                </li>
              </ul>
            </div>
            ...
            <div className={Style.planCard}>
              ...
              <ul>
                ...
                <li>
                  Four (4) Additional Complimentary Nights during each
                  Membership Year.
                </li>
                <li>
                  Redemption of Hospitality Reward Nights and Additional
            ...
            <p>
              <strong>2.3</strong> The Membership is personal in nature and
              shall be governed strictly by these Terms & Conditions.
            </p>
          </div>
          ...
          <div className={Style.formGroup}>
            ...
            <p>
              <strong>3.1</strong> The Membership shall remain valid for a
              period of <strong>Ten (10) Years</strong> from the date of
              activation.
            </p>
          ...
          <div className={Style.formGroup}>
            ...
            <p>
              <strong>4.1</strong> Subject to these Terms & Conditions, the
              Member shall be eligible to receive annual reward benefits
              equivalent to
            ...
            <p>
              ...
              adjustment and reduction based on the Member’s usage of
              Hospitality Reward Nights as specified under Clause 6.
            </p>
          </div>
          ...
          <div className={Style.formGroup}>
            ...
            <p>
              ...
              <strong>Four (4) Hospitality Reward Nights</strong> across
              selected Fracspace properties and/or affiliated hospitality
              partners, subject to availability and booking policies.
            </p>
          ...
          <div className={Style.formGroup}>
            ...
            <p>
              <strong>6.3</strong> Additional Complimentary Nights shall not
              alter the above reward reduction structure.
            </p>
          </div>
          ...
          <div className={Style.formGroup}>
            ...
            <ul>
              ...
              <li>
                The Company may suspend or terminate Membership for misuse,
                fraud, misconduct, policy violations or unauthorized commercial
                use.
              </li>
          ...
          <div className={Style.formGroup}>
            ...
            <p>
              ...
              civil unrest, technical failures or any event beyond its
              reasonable control.
            </p>
          </div>
          ...
          <div className={Style.formGroup}>
            ...
            <p>
              ...
              confirms that these Terms & Conditions have been read and
              understood and agrees to abide by all policies, operational
              guidelines and amendments issued by the Company from time to time.
            </p>
          </div>
        </div>
      </div>
