          ...
          {loading ? (
            ...
            <>
              ...
              <p className={Style.description}>
                ...
                not be completed. This may have
                occurred due to network issues,
                payment interruption, bank decline,
                insufficient balance, or an
              ...
              <p className={Style.supportText}>
                If the amount was debited but your
                payment still shows as failed,
