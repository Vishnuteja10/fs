  ...
  <img className={`${Style.watsapp} ${Style.bounce}`} src={watsappImg}></img>
      ...
      <div className={Style.PrivacyPolicy}>
        ...
        <p>
          ...
          Privacy Policy delineates the kinds of information we may gather from
          you and the measures we take to utilize and safeguard that
          information.
        </p>
        <p>
        ...
        <p>
          ...
          identifies or can be used to identify, contact or locate the user such
          as name, address, email address and phone number.
        </p>
        <p>
          Any data that is automatically captured by the website such as your
          mobile phone operating system, every computer/mobile device connected
          to the internet is given a domain name and a set of numbers that serve
          as that computer's Internet Protocol or “IP” address. When you request
          a page from any page within the website, our web servers automatically
        ...
        <h5 className={Style.subHeader}>2. USE OF THE INFORMATION COLLECTED </h5>
        <p>
          The company collects information primarily to facilitate the provision
          of services. This information may be used in various ways, including:
        </p>
        ...
        <p>
          ...
          mandated by law, or if we deem such disclosure necessary to safeguard
          our legal rights or adhere to legal obligations.
        </p>
        ...
        <p>
          ...
          stored in server logs, which cannot identify individuals. Through our
          web server, we gather anonymous data like web server cookies, IP
          addresses, domain servers, computer, and web browser types. Users can
          terminate accounts anytime, but information may remain in server
          archives after deletion.
        </p>
        <h5 className={Style.subHeader}>4. YOUR CHOICES AND RIGHTS</h5>
        <p>
          You have the option to opt out of receiving promotional communications
          from us at any time. This can be done by contacting us through our
          Fracspace website or by following the opt-out instructions provided in
          our communications.
        </p>
        <h5 className={Style.subHeader}>5. DATA SECURITY</h5>
        <p>
          We implement suitable measures to safeguard your personal information
          from unauthorized access, disclosure, or misuse. Nevertheless, it's
          important to note that no data transmission over the internet or any
          wireless network can be guaranteed to be completely secure.
        </p>
