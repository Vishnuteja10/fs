...
import OffersTopBanner from "../OffersTopBanner/OffersTopBanner";
      ...
      <nav>
        <div className={`${menuOpen ? Style.mobileMain : Style.main}`}>
          ...
          {!isMobile ? (
            ...
            <div
              className={`${scrolled ? Style.main3 : Style.main2} `}
              onClick={(e) => toggleMenu(e)}
            >
              <div
                className={`${
                  !scrolled && menuOpen ? Style.menuButton2 : Style.menuButton
                } `}
                onClick={(e) => toggleMenu(e)}
              >
                &#9776;
