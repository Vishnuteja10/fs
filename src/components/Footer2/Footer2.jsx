const Footer2 = () => {
  return (
    ...
    >
        ...
        >
          ...
          <div style={{ flex: "1 1 200px", marginBottom: "20px" }}>
            ...
            <p>
              ...
              estate projects. Explore our platform to discover how you can
              invest smartly and enjoy exclusive benefits.
            </p>
            <div>
          ...
          <div style={{ flex: "1 1 200px", marginBottom: "20px" }}>
            <h4>Contact Info</h4>
            <p>
              504 D, 5th Floor, RK Residency Road No.11, Banjara Hills,
              Hyderabad 500034.
            </p>
            <p>
              Email:{" "}
              <a href="mailto:support@fracspace.com">support@fracspace.com</a>
            </p>
          ...
          <div style={{ flex: "1 1 150px", marginBottom: "20px" }}>
            ...
            <div>
              <a href="#">
                <img
                  src="path/to/ios-app-icon.png"
                  alt="iOS"
                  style={{ marginRight: "10px" }}
                />
              </a>
              <a href="#">
                <img src="path/to/android-app-icon.png" alt="Android" />
              </a>
            </div>
          </div>
        </div>
      ...
      >
        <p>
          © 2024 <strong>Fracspace</strong>. All rights reserved.
        </p>
